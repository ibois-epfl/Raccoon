// joinery_solver_rhino6PlugIn.cpp : defines the initialization routines for the plug-in.
//
...
RHINO_PLUG_IN_NAME(L"joinery_solver_rhino6");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"98E18D78-5254-43BE-A2AA-79BE2B9D1112");
...
RHINO_PLUG_IN_DESCRIPTION(L"joinery_solver_rhino6 plug-in for Rhinoceros®");
...
// The one and only Cjoinery_solver_rhino6PlugIn object
static class Cjoinery_solver_rhino6PlugIn thePlugIn;

/////////////////////////////////////////////////////////////////////////////
// Cjoinery_solver_rhino6PlugIn definition

Cjoinery_solver_rhino6PlugIn& joinery_solver_rhino6PlugIn()
{
	// Return a reference to the one and only Cjoinery_solver_rhino6PlugIn object
	return thePlugIn;
}

Cjoinery_solver_rhino6PlugIn::Cjoinery_solver_rhino6PlugIn()
{
	// Description:
	//   Cjoinery_solver_rhino6PlugIn constructor. The constructor is called when the
	//   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	//   is loaded, Cjoinery_solver_rhino6PlugIn::OnLoadPlugIn() is called. The
...
const wchar_t* Cjoinery_solver_rhino6PlugIn::PlugInName() const
{
	// Description:
...
const wchar_t* Cjoinery_solver_rhino6PlugIn::PlugInVersion() const
{
	// Description:
...
GUID Cjoinery_solver_rhino6PlugIn::PlugInID() const
{
	// Description:
	...
	// {98E18D78-5254-43BE-A2AA-79BE2B9D1112}
...
BOOL Cjoinery_solver_rhino6PlugIn::OnLoadPlugIn()
{
	// Description:
...
void Cjoinery_solver_rhino6PlugIn::OnUnloadPlugIn()
{
	// Description:
