...
namespace CGAL_PlaneUtil {
    ...
    inline IK::Point_3 line_line(IK::Line_3& l0, IK::Line_3& l1) {

        IK_to_EK ie; EK_to_IK ei;
        auto result0 = CGAL::intersection(ie(l0), ie(l1));
        return ei(*boost::get<EK::Point_3>(&*result0));

    }
    inline IK::Point_3 line_line(IK::Segment_3& l0, IK::Segment_3& l1) {
    ...
    inline IK::Vector_3 vector_two_planes(IK::Vector_3& v, IK::Plane_3& plane0, IK::Plane_3& plane1) {
        ...
        auto result0 = CGAL::intersection(ie(line), ie(plane0));
        auto result1 = CGAL::intersection(ie(line), ie(plane1));
    ...
    inline IK::Vector_3 orthogonal_vector_between_two_plane_pairs(IK::Plane_3& plane_pair0_0, IK::Plane_3& plane_pair1_0, IK::Plane_3& plane_pair1_1) {
        ...
        IK_to_EK ie; EK_to_IK ei;
        auto result0 = CGAL::intersection(ie(plane_pair0_0), ie(plane_pair1_0));
        auto result1 = CGAL::intersection(ie(plane_pair0_0), ie(plane_pair1_1));

        IK::Line_3 l0 = ei(*boost::get<EK::Line_3>(&*result0));
        IK::Line_3 l1 = ei(*boost::get<EK::Line_3>(&*result1));
    ...
    inline CGAL_Polyline plane_4_planes(IK::Plane_3& mainPlane, IK::Plane_3(&sequence_of_planes)[4]) {
        ...
        IK_to_EK ie; EK_to_IK ei;
        auto result0 = CGAL::intersection(ie(sequence_of_planes[0]), ie(sequence_of_planes[1]), ie(mainPlane));
        auto result1 = CGAL::intersection(ie(sequence_of_planes[1]), ie(sequence_of_planes[2]), ie(mainPlane));
        auto result2 = CGAL::intersection(ie(sequence_of_planes[2]), ie(sequence_of_planes[3]), ie(mainPlane));
        auto result3 = CGAL::intersection(ie(sequence_of_planes[3]), ie(sequence_of_planes[0]), ie(mainPlane));
        IK::Point_3 p0 = ei(*boost::get<EK::Point_3>(&*result0));
        IK::Point_3 p1 = ei(*boost::get<EK::Point_3>(&*result1));
    ...
    inline IK::Point_3 LinePlane(IK::Line_3& line, IK::Plane_3& plane) {
        ...
        IK_to_EK ie; EK_to_IK ei;
        auto result0 = CGAL::intersection(ie(line), ie(plane));
        return ei(*boost::get<EK::Point_3>(&*result0));
    ...
    inline IK::Point_3 SegmentPlane(IK::Segment_3& segment, IK::Plane_3& plane) {
        ...
        IK_to_EK ie; EK_to_IK ei;
        auto result0 = CGAL::intersection(ie(segment), ie(plane));
    ...
    inline bool Plane4LinesIntersection(IK::Plane_3& plane, IK::Segment_3& l0, IK::Segment_3& l1, IK::Segment_3& l2, IK::Segment_3& l3, CGAL_Polyline& output) {
        ...
        IK_to_EK ie; EK_to_IK ei;
        auto result0 = CGAL::intersection(ie(l0), ie(plane) );
        auto result1 = CGAL::intersection(ie(l1), ie(plane) );
        auto result2 = CGAL::intersection(ie(l2), ie(plane) );
        auto result3 = CGAL::intersection(ie(l3), ie(plane) );
        IK::Point_3 p0 = ei(*boost::get<EK::Point_3>(&*result0));
        IK::Point_3 p1 = ei(*boost::get<EK::Point_3>(&*result1));
        IK::Point_3 p2 = ei(*boost::get<EK::Point_3>(&*result2));
        IK::Point_3 p3 = ei(*boost::get<EK::Point_3>(&*result3));
    ...
    inline bool PlaneLineIntersection(IK::Plane_3& plane, IK::Segment_3& l0, IK::Point_3& output) {
        ...
        IK_to_EK ie; EK_to_IK ei;
        auto result0 = CGAL::intersection(ie(plane), ie(l0));
        output = ei(*boost::get<EK::Point_3>(&*result0));
